            ...
            <g>
                <g>
                    ...
                    <path
                        ...
                        transform="translate(-21 -4fillOpacity33) translate(21 433)"
                    />
                    <path
                        fill="#FFF"
                        fillOpacity=".6"
...
export const MagnifyingGlassIcon = ({ width = '1.6rem', height = '1.6rem', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const ClearIcon = ({ width = '1.1rem', height = '1.1rem', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
