...
function WeekChartSong({ songInfo, index }) {
    ...
    return (
        ...
        >
            <div className="flex items-center flex-5">
                <span className="text-shadow-4 mr-[15px] w-[60px] flex items-center justify-center text-[32px] text-[#411636]">
                    {index + 1}
                </span>
...
export default memo(WeekChartSong);
